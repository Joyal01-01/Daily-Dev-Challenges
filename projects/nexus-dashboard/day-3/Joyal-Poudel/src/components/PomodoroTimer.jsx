  ...
  return (
    <div className="glass-panel" style={{ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', marginBottom: '1.5rem' }}>
        <h3 style={{ color: 'var(--color-text)', fontSize: '0.875rem', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem' }}>
        <svg width="180" height="180" viewBox="0 0 180 180" style={{ transform: 'rotate(-90deg)' }}>
          ...
          <circle
            ...
            r={radius}
            fill="transparent"
            stroke={isBreak ? '#10b981' : 'var(--color-accent)'}
            strokeWidth="8"
      ...
      <div style={{ display: 'flex', gap: '1rem' }}>
        <button 
          ...
          style={{
            ...
            borderRadius: '50%',
            border: 'none',
            background: isActive ? 'var(--color-secondary)' : 'var(--color-accent)',
            color: isActive ? '#fff' : 'white',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            cursor: 'pointer',
            boxShadow: isActive ? 'none' : '0 0 20px -5px rgba(59, 130, 246, 0.5)',
